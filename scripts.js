<script>
  ...
  // ---------------------------
  const modulesData = [
    { href: "https://wa.me/12817839998", img: "https://cdn-icons-png.flaticon.com/512/124/124034.png", text1: "WhatsApp", text2: "+1 281 783 9998" },
    { href: "mailto:sales@oliverfr.com", img: "https://cdn-icons-png.flaticon.com/512/732/732200.png", text1: "Email", text2: "sales@oliverfr.com" },
    { href: "tel:+12817839998", img: "https://cdn-icons-png.flaticon.com/512/126/126509.png", text1: "Phone", text2: "+1 281 783 9998" },
    { href: "https://linkedin.com/in/oliver-f-448b8a287", img: "https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png", text1: "LinkedIn", text2: "" },
    { href: "https://web.skype.com/?openPstnPage=true", img: "Skype Logo.png", text1: "Skype", text2: "" },
    { href: "weixin://dl/chat?wxid=wxid_kesvxwp296ci12", img: "WeChat Logo.png", text1: "WeChat", text2: "" }
  ];
  ...
  // Create the first batch of items
  for (let i = 0; i < 6; i++) {
    createItem();
  }
